...
//Using a condition to see if someone has to pay taxes depending on their age and gender.
if ($sexe == "F" && $age >= 18 && $age <= 35 || $sexe == "M" && $age > 20) {
    $result = "est imposable";
} else {
    $result = "n'est pas imposable";
}

echo "Âge : $age<br>";
echo "Sexe : $sexe<br>";
echo "La presonne $result";